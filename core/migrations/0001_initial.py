# Generated by Django 4.2.7 on 2024-10-08 06:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('student', 'Student'), ('academic_staff', 'Academic Staff'), ('non_academic_staff', 'Non-Academic Staff'), ('senior_management', 'Senior Management')], max_length=50)),
                ('is_lecturer', models.BooleanField(default=False)),
                ('is_invigilator', models.BooleanField(default=False)),
                ('is_exam_committee_member', models.BooleanField(default=False)),
